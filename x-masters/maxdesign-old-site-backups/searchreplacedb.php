...
$usr  = 'maxdesig_wrdp1';       // your db userid
$pwd  = 'LVxBCP87uPMv';                 // your db password
$db   = 'maxdesig_wrdp1';           // your database

// Replace options

$search_for   = 'russ.davidmcdonald.org';  // the value you want to search for
$replace_with = 'www.maxdesign.com.au';  // the value to replace it with
